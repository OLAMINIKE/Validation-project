import logging
from data_ingestion import create_db_engine
from data_ingestion import query_data
...
class FieldDataProcessor:
    ...
    def weather_station_mapping(self):
        weather_data_df = read_from_web_CSV(self.weather_map_data)
        # Assuming 'Field_ID' is the common identifier/key
        self.df = self.df.merge(weather_data_df, on='Field_ID', how='left')    
